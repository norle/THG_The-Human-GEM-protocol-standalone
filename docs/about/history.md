...
THG (The Human GEM protocol) is a scientific workflow for curating and
combining human metabolic-model information. Its scientific origin is the
[2023 protocol paper](https://doi.org/10.3390/bioengineering10050576), which
describes a reference GEM branch, a complementary Human Database, and a final
validated model.
...
inputs, services, versions, and artifact evidence.
